  ...
  <div>
    <main class="bg-main">
      ...
      >
        ...
        <a
          class="sm:block hidden max-w-lg"
          href="https://www.kickstarter.com/projects/collanatrivio/librigame-collana-trivio"
          target="_blank"
        >
          <div class="bg-ks p-4 mx-auto rounded-lg cursor-pointer">
    ...
    >
      <div class="flex-1 p-8">
        <h3 class="text-brand-light mb-2 text-lg font-bold">LIBRIGAME</h3>
        <p>
      ...
      <div class="flex-1 p-8">
        <h3 class="text-brand-light mb-2 text-lg font-bold">TRE STRADE</h3>
        <p>
      ...
      <div class="flex-1 p-8">
        <h3 class="text-brand-light mb-2 text-lg font-bold">CROWDFUNDING</h3>
        <p>
    ...
    <div class="bg-brand-dark">
      <book-list class="lg:flex-row flex flex-col p-10" :books="books" />
    </div>
  </div>
</template>
